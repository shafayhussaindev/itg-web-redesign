...
import { industryPages, industryDetail as copy } from '@/content/tier2/industry-detail.js';
 ...
 * sector as sections. Shares the tier-2 foundation (`tier2/shared/base.css`)
